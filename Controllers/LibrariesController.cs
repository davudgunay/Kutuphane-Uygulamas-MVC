...
namespace LibraryMVC.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        {
            var libraryMVCContext = _context.Library.Include(l => l.District);
            return View(await libraryMVCContext.ToListAsync());
        }

        public async Task<PartialViewResult> DistrictLibraries(short districtId)
        {
            var libraryMVCContext = _context.Library.Where(l => l.DistrictId == districtId).OrderBy(l => l.Name);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CityId"] = new SelectList(_context.City.OrderBy(c=>c.Name), "PlateCode", "Name", library.District.CityId);
            ViewData["DistrictId"] = new SelectList(_context.District.Where(d=>d.City.PlateCode==library.District.CityId).OrderBy(d=>d.Name), "Id", "Name", library.DistrictId);
            return View(library);
        }
