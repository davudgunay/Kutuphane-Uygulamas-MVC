...
namespace LibraryMVC.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        {
            var libraryMVCContext = _context.District.Include(d => d.City).OrderBy(d=>d.City.Name).ThenBy(d=>d.Name);
            return View(await libraryMVCContext.ToListAsync());
        }

        public async Task<PartialViewResult> CityDistricts(byte cityId)
        {
            var libraryMVCContext = _context.District.Where(d => d.CityId == cityId).OrderBy(d => d.Name);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Population,CityId")] District district)
        {
        ...
        public async Task<IActionResult> Edit(short? id)
        {
            ...
            ViewData["CityId"] = new SelectList(_context.City.OrderBy(c => c.Name), "PlateCode", "Name", district.CityId);
            return View(district);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("Id,Name,Population,CityId")] District district)
        {
            if (id != district.Id)
            {
                return NotFound();
